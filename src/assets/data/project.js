...
export default [
  ...
  {
    id: "2",
    name: " Android encryption and video sharing",
    description:
  ...
  },
  {
    ...
    description:
      "The library management app simplifies library operations by providing a comprehensive solution for book cataloging, lending, returns, and tracking of overdue books. Its key features include a comprehensive database of books with easy accessibility, a user-friendly interface for library staff to manage book circulation, and the ability for administrators to manage staff accounts and monitor library operations. This app is an efficient and reliable tool for libraries of all sizes, improving the overall library experience for patrons.",
    img: Img,
    link: "https://github.com/hashanranasinghe/library_management_app.git",
  },
  {
    id: "4",
    name: "Safe Park",
  ...
  },
  {
    ...
    name: "ToDo App",
    description:
      "This application offers users a user-friendly interface that enables them to convert units based on their specific requirements. With this app, users can effortlessly convert measurements of length, weight, volume, temperature, and more, into their desired units.",
    img: Img,
